...
<head>
    ...
    <title>Kittfill — {{ config('app.name', 'Kittfill') }}</title>
...
<body class="min-h-screen flex flex-col font-sans antialiased bg-white">
    ...
    <nav class="kf-nav sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between">
            ...
            <div class="hidden md:flex items-center gap-8">
                <a href="{{ route('home') }}" class="kf-nav-link">Home</a>
                <a href="{{ route('shop') }}" class="kf-nav-link">Shop</a>
                <a href="{{ route('about') }}" class="kf-nav-link">About Us</a>
                <a href="{{ route('faq') }}" class="kf-nav-link">FAQ</a>
                <a href="{{ route('contact') }}" class="kf-nav-link">Contact</a>
            </div>
            <div class="flex items-center gap-5">
                <a href="{{ route('cart') }}" class="kf-icon-btn" title="Cart">
    ...
    {{-- Footer --}}
    <footer style="background-color: #b8c2dc;" class="border-t border-blue-200/40">
